...
import { Grid, Paper, Button, TextField, Card, CardContent, Typography  , Skeleton} from '@mui/material';
...
const MapView = () => {
  ...
  const PaperStyle = { width: 820, marginTop: "20px", marginLeft: "20px", height: "640px" }; //height = 550
  const PaperStyle2 = { marginTop: "20px", marginLeft: "20px", marginBottom: "10px", padding: "10px 10px", width: 820, height: "400px" };
        ...
        <Paper elevation={5} style={PaperStyle} sx={{ borderRadius: 2 }}>
          <div style={{ width: '100%', height: '100%' }}>
            {isLoaded ? (
              ...
              <Skeleton variant="rectangular" height={640} animation="wave" />
            )}
          </div>
        </Paper>
      </Grid>
      ...
      <Grid item xs={12} md={6}>
        <Paper elevation={10} style={PaperStyle2} sx={{ borderRadius: 2, padding: "30px 30px", backgroundColor: "", boxShadow: "0px 4px 8px rgba(0, 0, 0, 0.1)" }}>
          ...
          <div style={{ marginBottom: "20px", paddingLeft: "27px" }}>
            ...
            <Button variant='outlined' onClick={handleSearchDestination} style={{ marginLeft: "10px", borderRadius: "5px", padding: "8px" }}>Search</Button>
          </div>
